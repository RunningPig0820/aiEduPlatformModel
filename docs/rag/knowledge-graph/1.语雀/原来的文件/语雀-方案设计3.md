...
> 来源：https://www.yuque.com/zhangmin-jrrer/iu9s4m/gp3fl714kqxb190h
> 字数：15988 ｜ 下载：2026-08-24
...
CREATE TABLE kp_source_mapping (
    ...
    confidence FLOAT DEFAULT 1.0,     -- 匹配置信度
    UNIQUE KEY uk_canonical_external_source (canonical_uri(255), external_id(255), source_name(255))
...
+ 知识点"一元二次方程"定义：_"含有一个未知数，且未知数的最高次数是 2 的整式方程"_
