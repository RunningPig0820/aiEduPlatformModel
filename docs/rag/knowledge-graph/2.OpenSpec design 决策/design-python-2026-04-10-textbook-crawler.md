> summary: 人教版数学教材目录爬虫设计，解决 EDUKG main.ttl 小学初中教材标注缺失问题，从教师之家爬取小学/初中/高中全套章节与知识点，同时输出 JSON 与兼容 main.ttl 的 TTL 格式，数据按 学科-教材-学段-年级 四级目录组织，选用 requests+BeautifulSoup4 静态页面爬取。
> 权威度: 0.7
> 模块: knowledge-graph
> COS路径: rag-source/knowledge-graph/OpenSpec设计决策/design-python-2026-04-10-textbook-crawler.md
> 类别：操作流程

# design-python-2026-04-10-textbook-crawler（人教版数学教材目录爬虫）
