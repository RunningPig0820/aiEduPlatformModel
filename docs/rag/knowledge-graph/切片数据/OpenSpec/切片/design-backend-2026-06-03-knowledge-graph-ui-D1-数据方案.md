...
> summary: 决策：MySQL存核心节点属性与层级关系，图谱关系（MATCHES_KG/PART_OF等）不同步、后续直接查Neo4j；给出t_kg_textbook等主表与层级关系表SQL设计。
> 权威度: 0.7
> 模块: knowledge-graph
> COS路径: rag-slices/knowledge-graph/OpenSpec/design-backend-2026-06-03-knowledge-graph-ui-D1-数据方案.md
> 类别：数据存储
...
> 证据：详见 `2.OpenSpec design 决策/design-backend-2026-06-03-knowledge-graph-ui.md`（§D1：数据方案：Neo4j → MySQL 同步 + Neo4j 关系查询）
