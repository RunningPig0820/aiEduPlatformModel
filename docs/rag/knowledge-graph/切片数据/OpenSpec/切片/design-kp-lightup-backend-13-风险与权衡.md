...
> 权威度: 0.7
> 模块: knowledge-graph
> COS路径: rag-slices/knowledge-graph/OpenSpec/design-kp-lightup-backend-13-风险与权衡.md
> 类别：开发难点

---

> 检索摘要：kp-matching-lightup 主要风险——冷启动依赖 LLM 种子、候选名幻觉、LLM 自证循环、开发者打标脱离解题、学生恶意投票、obs 长期尾膨胀等，分别以镜像校验/WEAK 弱化/客观信号校准/人工边界仲裁/去重计数等缓解。
