> summary: 掌握度信号题型化技术设计：mastery_signals 语义从知识点翻转为题型、字段改名 topic_label、mastery_snapshot 脱钩与题型名稳定规范，防污染后端题型库。
> 权威度: 0.7
...
> 状态：✅
> 检索摘要：question_kps 继续输出知识点，signal 枚举不变（Java 映射 75/50/25）。
