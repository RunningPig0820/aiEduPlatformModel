> summary: 项目介绍RAG语料构建规范spec:完善文档8节生成与冲突以代码为准、按章节切片与metadata(page/doc_type/section/permissions/source_doc/order)、dashscope 768维嵌入维度一致性、COS rag-index幂等构建与demo预建、每页5~8条索引层QA条目提炼,是双池语料的构建与入库规范。
> 权威度: 0.7
> 模块: rag-system
> COS路径: rag-source/rag-system/OpenSpec设计决策/spec-python-project-intro-rag-rag-corpus.md
> 类别: 操作流程

# spec-python-project-intro-rag-rag-corpus(项目介绍 RAG 语料与切片规范)
